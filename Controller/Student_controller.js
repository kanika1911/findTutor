...
const getStudentSignup = (req, res) => {
    const { name, email, phone, subjects, password, confirmpassword, city, pincode, classname, address } = req.body;
...
const EditStudent = (req, res) => {
    const { name, email, phone, subjects, city, pincode, classname, address, _id } = req.body;
    console.log(req.body);
